...
SAMPLE_HEIC = SAMPLE_IMAGES / "20260525-IMG_7906.heic"
...
def test_sniff_image_format_detects_heic_from_real_sample() -> None:
    with SAMPLE_HEIC.open("rb") as image_file:
        assert sniff_image_format(image_file.read(), SAMPLE_HEIC.name) == ImageFormat.HEIC
